...
def main():
    ...
    pickle.dump( moods, open( "/srv/glusterfs/csevim/datasets/affectnet/train_5d_%s.pkl" % trainer._opt.model, "wb" ) )
    ...
    moods = trainer.get_last_fc_single_image(img_dir, list_of_images, transform)
    pickle.dump( moods, open( "/srv/glusterfs/csevim/datasets/affectnet/test_5d_%s.pkl" % trainer._opt.model, "wb" ) )
    print('END!')
